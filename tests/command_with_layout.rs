...
fn command_with_layout_0() {
    ...
    assert_eq!(actual, format!("{}\n", EXAMPLE_GROUPS_STYLE_SYMBOLS_LAYOUT_0));
}
...
fn command_with_layout_1() {
    ...
    assert_eq!(actual, format!("{}\n", EXAMPLE_GROUPS_STYLE_SYMBOLS_LAYOUT_1));
}
...
fn command_with_layout_2() {
    ...
    assert_eq!(actual, format!("{}\n", EXAMPLE_GROUPS_STYLE_SYMBOLS_LAYOUT_2));
}
...
fn command_with_layout_units() {
    ...
    assert_eq!(actual, format!("{}\n", EXAMPLE_GROUPS_STYLE_SYMBOLS_LAYOUT_UNITS));
}
